...
const SocialLink = ({
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer" className="group">
      ...
      <Icon className="h-5 w-5 fill-foreground/50 transition group-hover:fill-foreground dark:group-hover:fill-foreground" />
    </a>
  );
};
    ...
    <footer className="border-t py-6 w-full">
      <div className="container flex flex-col items-center justify-between gap-5 sm:flex-row">
        ...
        <div className="flex gap-4">
          ...
          <SocialLink href="http://github.com/thvroyal" icon={GitHubIcon}>
            Follow me on GitHub
          </SocialLink>
